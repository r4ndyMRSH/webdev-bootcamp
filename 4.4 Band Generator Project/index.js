...
function randomElement(arr) {
  ...
  let firstLetter = arr[r].charAt(0).toUpperCase();
  let remindLetters = arr[r].slice(1);
  return firstLetter + remindLetters;
}
...
app.post("/submit", (req, res) => {
  ...
  res.render("index.ejs", {
    first: randomElement(adj),
    second: randomElement(noun),
  });
});
